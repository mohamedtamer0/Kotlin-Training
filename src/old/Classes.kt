...
class InitOrderDemo(name: String) {
    val firstProperty = "old.First property : $name".also(::println)

    init {
        println("old.First initializer block that prints ${name}")
    }

    val secondProperty = "old.Second property: ${name.length}".also(::println)

    init {
        println("old.Second initializer block that prints ${name.length}")
    }
...
//class old.Car (val make: String, val model: String, var color: String) {
//    fun accelerate() {
//        println("vroom")
//    }
//    fun details() {
...
//
//
//fun old.main(args: Array<String>) {
//
